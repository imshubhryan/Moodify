        ...
        <main className="register-page">
            <div className="form-container">
                ...
                <form onSubmit={handleSubmit}  >
                    ...
                    onChange={(e)=>{setUsername(e.target.value)}} label="Name" placeholder="Enter your name" />
                    <FormGroup value={email} 
                    onChange={(e)=>{setEmail(e.target.value)}} label="Email" placeholder="Enter your email" />
